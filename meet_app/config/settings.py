    ...
    * DB_USER
    ...
    REST_FRAMEWORK = {
        "DEFAULT_AUTHENTICATION_CLASSES": (
            # Ajoute au socle v1.24.0 lauthentification par jeton porteur, que
            # limage de production declare deja. Sans elle, un client mobile ne
            # peut pas sauthentifier : seule la session Django etait acceptee,
            # donc /api/v1.0/users/me/ repondait 401 a tout Bearer.
    ...
    # OIDCAuthentication delegue la creation de lutilisateur a ce backend.
    # Sans cette ligne il retomberait sur celui de mozilla_django_oidc, qui ne
    # sait pas construire un User tel que meet lattend.
